...
export const dict = {
  ...
  "command.splitView.toggle": "Toggle split view",
  ...
  "settings.general.row.agentSplit.layout.title": "Layout",
  "settings.general.row.agentSplit.layout.description": "How subagent panes are arranged",
  ...
  "settings.general.row.agentSplit.paneLimit.title": "Max panes",
  "settings.general.row.agentSplit.paneLimit.description": "Maximum number of subagent panes to show (2-8)",
  "settings.general.row.agentSplit.paneLimit": "Pane limit",
  "settings.general.row.agentSplit.idleHideSeconds.title": "Auto-hide timeout",
  "settings.general.row.agentSplit.idleHideSeconds.description": "Seconds to wait before hiding idle subagents (1-60)",
